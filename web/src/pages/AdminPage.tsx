...
const tabs = ['dashboard', 'servicos', 'equipe', 'agenda', 'clientes', 'aparencia'] as const
        ...
        <section className="admin-panel">
          ...
          {activeTab === 'aparencia' && (
            <div className="booking-card">
              ...
              <input id="theme-primary" placeholder="#1e6a43" />
              <label>Cor secundaria</label>
              <input id="theme-secondary" placeholder="#d19b1f" />
